...
<section>
    ...
    <div class="left-side sticky-left-side">
        ...
        <div class="logo">
            <h1><a href="../">Manager <span>Shop</span></a></h1>
        </div>
        ...
        <div class="left-side-inner">
            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
                <li class="active"><a href="/"><i class="lnr lnr-power-switch"></i><span>Trang Chủ</span>
                </a></li>
                <li><a href="/updatenhanvien"><i class="lnr lnr-user"></i> <span>Quản Lý Nhân Viên</span></a></li>
                <li class="menu-list">
                ...
                <div class="switches">
                    <div class="col-4">
                        ...
                        <div class="col-md-4 switch-right">
                            ...
                            <div class="sparkline">
                                <!--graph-->
                                <link rel="stylesheet" href='<c:url value="/resources/css/graph.css"/> '/>
                                ...
                                <script>
                                    $(document).ready(function () {
                                        ...
                                        var graphData = [{
                                            // Returning Visits
                                            data: [ [4, 4500], [5,3500], [6, 6550], [7, 7600],[8, 4500], [9,3500],
                                                [10, 6550], ],
                                            color: '#FFCA28',
                                    ...
                                    <div class="single-bottom">
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                <label for="brand9"><span>

                                                </span> Pain that produces no resultant.</label>
                                            </li>
                                            <li>
